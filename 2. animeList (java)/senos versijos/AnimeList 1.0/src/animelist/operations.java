...
public class operations {
    ...
    public operations(AnimeListWindow window){
        try {
            ...
            sortList(knownList);
            makeReccomendedList();
            showImputedEntities(seenList, window1.getJTable1());
            showImputedEntities(watchingList, window1.getJTable3());
            showImputedEntities(knownList, window1.getJTable2());
            showImputedEntities(reccomendedList, window1.getJTable4());
            //sudarom ID sarasa
            calculateIdIndex();
    ...
    private void showImputedEntities(ArrayList list, javax.swing.JTable jTable){
        try {
